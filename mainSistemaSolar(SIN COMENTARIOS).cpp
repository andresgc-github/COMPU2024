...
void CalcularEnergia(double E[SIZExy],double m[SIZExy],double r[SIZExy],double v[SIZExy],double &E_TOTAL);
...
int main(){
    ...
    int i;  
    double t=0.0; double h=0.1*k; double E_TOTAL=0.0;

    do{
        CalcularEnergia(E,m,r,v,E_TOTAL);
        Escribir(E,energiasR);    
        // cout << E_TOTAL << endl; //da segmentation fault 
